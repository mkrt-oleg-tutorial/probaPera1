...
// Database
import Database_ProbaPera1_db from "./Database_ProbaPera1_db.js";

// Controllers
import ParentsController from "../controllers/ProbaPera1_db/ParentsController";
import StudentController from "../controllers/ProbaPera1_db/StudentController";
import TutorController from "../controllers/ProbaPera1_db/TutorController";
import UserController from "../controllers/ProbaPera1_db/UserController";
...
class Server {
 ...
 // End Init Database
    ...
    // Start Init Controllers
		ParentsController.init(router);
		StudentController.init(router);
		TutorController.init(router);
